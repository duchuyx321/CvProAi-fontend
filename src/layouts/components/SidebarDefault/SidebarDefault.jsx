        ...
        <aside className={cx('sidebar')}>
            ...
            <div className={cx('logo-section')}>
                ...
                <div className={cx('brand-info')}>
                    ...
                    <span className={cx('brand-slogan')}>Hệ thống tạo CV bằng AI</span>
                </div>
            </div>
            ...
            <div className={cx('menu-section')}>
                <nav className={cx('nav-menu')}>
                    <NavLink to="/user/dashboard" className={({ isActive }) => cx('nav-item', { active: isActive })}>
                        <GoHome className={cx('icon')} />
                        <span className={cx('label')}>Trang chủ</span>
                    </NavLink>

                    <NavLink to="/user/templates" className={({ isActive }) => cx('nav-item', { active: isActive })}>
                        <IoDocumentTextOutline className={cx('icon')} />
                        <span className={cx('label')}>Mẫu CV</span>
                    </NavLink>

                    <NavLink to="/user/my-cvs" className={({ isActive }) => cx('nav-item', { active: isActive })}>
                ...
                <nav className={cx('nav-menu')}>
                    <NavLink to="/user/upgrade-premium" className={({ isActive }) => cx('nav-item', { active: isActive })}>
                        <FiAward className={cx('icon', 'icon-gold')} />
                        <span className={cx('label')}>Nâng cấp Premium</span>
                    </NavLink>

                    <NavLink to="/profile" className={({ isActive }) => cx('nav-item', { active: isActive })}>
            ...
            <div className={cx('capacity-section')}>
                <div className={cx('capacity-box')}>
                    ...
                    <div className={cx('progress-bar-bg')}>                      
                        <div className={cx('progress-bar-fill')} style={{ width: '66.6%' }}></div>
                    </div>
