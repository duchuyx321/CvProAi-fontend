...
export const MOCK_ADMIN_TEMPLATES = [
    {
        ...
        description:
            'Mẫu CV công nghệ hiện đại dành cho kỹ sư phần mềm.',
        is_premium: true,
        is_active: true,
        usage_count: 1245,
    ...
    },
    {
        ...
        description:
            'Thiết kế tối ưu cho hồ sơ kinh doanh và marketing.',
        is_premium: false,
        is_active: false,
        usage_count: 890,
    ...
    },
    {
        ...
        description:
            'Mẫu CV portfolio dành cho designer và creative team.',
        is_premium: true,
        is_active: true,
        usage_count: 2102,
    ...
    },
    {
        ...
        description: 'Bố cục hiện đại cho frontend developer.',
        is_premium: false,
        is_active: true,
        usage_count: 1688,
    ...
    },
    {
        ...
        description:
            'Mẫu CV tối giản, chuyên nghiệp cho môi trường văn phòng.',
        is_premium: false,
        is_active: true,
        usage_count: 760,
    ...
    },
    {
        ...
        description: 'Mẫu CV cao cấp cho vị trí quản lý.',
        is_premium: true,
        is_active: false,
        usage_count: 540,
